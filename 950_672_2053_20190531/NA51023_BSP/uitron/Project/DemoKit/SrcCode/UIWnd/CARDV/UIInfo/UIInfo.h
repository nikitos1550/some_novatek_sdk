...
typedef enum {
	...
	// System
    FL_MOVIE_PLAYBACK,////////////////////2016playback
...
enum _TUTK_MENU_TIMELAPSE
{
	MENU_TIMELAPSE_OFF,
	MENU_TIMELAPSE_1SEC,//1FPS
	MENU_TIMELAPSE_5SEC,//2FPS
	MENU_TIMELAPSE_3SEC,//3FPS
	MENU_TIMELAPSE_10SEC,//5FPS
	MENU_TIMELAPSE_30SEC,//10FPS
	MENU_TIMELAPSE_MAX,
};

enum _TUTK_SHUTDOWN_TIMELAPSE
{
	SHUTDOWN_TIMELAPSE_12H,
	SHUTDOWN_TIMELAPSE_24H,
	SHUTDOWN_TIMELAPSE_48H,
	SHUTDOWN_TIMELAPSE_72H,
	SHUTDOWN_TIMELAPSE_96H,
	SHUTDOWN_TIMELAPSE_MAX,
};
//-----------------------------------------------------------------------------
...
enum
{
   	PARKING_MONITONING_OFF = 0,
	PARKING_MONITONING_LOW,
	PARKING_MONITONING_MED,
	PARKING_MONITONING_HIGH,

	PARKING_MONITONING_MAX
};
...
#define WDT_MOVIE_MODE  1
#define WDT_PHOTO_MODE  2
#define WDT_PLAYBACK_MODE  3
#define WDT_CALIBRATION_MODE  4
#define WDT_USBCAM_MODE  5
#define WDT_USBCHARGE_MODE  6
#define WDT_USBDISK_MODE  7
#define WDT_USBFWUPDATE_MODE  8
#define WDT_USBMENU_MODE  9
#define WDT_USBPRINT_MODE  10
#define WDT_USBPTP_MODE  11
#define WDT_POWER_SHUTDOWN  12
#define WDT_WIFI_MODE  13

extern void WDT_Init(void);
extern void WDT_Wakeup(UINT32 idx);
extern void WDT_Sleep(UINT32 idx);
extern void WDT_Trigger(UINT32 idx);
extern BOOL WDT_IsWakeup(void);
extern void WDT_SensorVDSignal_Check(UINT32 overcnt);
extern void WDT_OverTimeShutDownTimerHdl(UINT32 uiEvent);
extern void WDT_OverTimeShutDownTimer(void);
