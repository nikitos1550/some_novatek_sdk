...
EVENT_ITEM(NVTEVT_KEY_MENU, UIFlowWndPlay_OnKeyMode)
...
#else //(NMEDIAPLAY_FUNC == ENABLE)
                g_UIPlayMediaObj.CallBackFunc    = UIAppPlay_MoviePlayCB;
#endif
