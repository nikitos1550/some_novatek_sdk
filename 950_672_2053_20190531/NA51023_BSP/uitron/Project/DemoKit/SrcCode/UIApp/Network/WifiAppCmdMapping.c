...
WIFIAPPINDEXMAP gPrakmonitionMap[] = {
	{PARKING_MONITONING_OFF, "OFF"  },
	{PARKING_MONITONING_LOW, "LOW"  },
	{PARKING_MONITONING_MED, "MED"  },
	{PARKING_MONITONING_HIGH,"HIGH" },
	{INDEX_END, 0}
};
...
WIFIAPPMAP wifiAppFlagMap[] = {
    ...
    {FL_PARKING_MONITONING, "MOVIE_PARK", gSensorMap},
