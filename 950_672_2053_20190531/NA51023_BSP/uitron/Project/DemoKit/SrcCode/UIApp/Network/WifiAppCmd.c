...
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK, NVTEVT_WIFI_EXE_PARKING_MOTION, 0, 0, FL_PARKING_MONITONING)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK_MIOCAM, NVTEVT_WIFI_EXE_PARKING_MOTION, 0, 0, FL_PARKING_MONITONING)
WIFI_CMD_ITEM(WIFIAPP_CMD_MOVIE_PARK_ROADCAM, NVTEVT_WIFI_EXE_PARKING_MOTION, 0, 0, FL_PARKING_MONITONING)
