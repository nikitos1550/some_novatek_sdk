...
//#NT#-----------------------------------------------------
#define WIFIAPP_CMD_WIFIAP_SEARCH             8050//3038 The original factory is temporarily set aside
//#NT#2016/06/06#Charlie Chang -end
#define WIFIAPP_CMD_MOVIE_PARK           3038   // For Hui Che Tian Xia
#define WIFIAPP_CMD_MOVIE_PARK_MIOCAM           8005 // For Miocam
#define WIFIAPP_CMD_MOVIE_PARK_ROADCAM           8020 // For Miocam
