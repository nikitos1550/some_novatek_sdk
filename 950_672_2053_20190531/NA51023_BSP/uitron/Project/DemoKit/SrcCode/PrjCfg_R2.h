...
#define FW_VERSION_NUM                  "WH-675-AHD-20190315"
...
#define WATERLOGO_FUNCTION              DISABLE//ENABLE  // Enable/Disable waterlogo function
...
#define PIP_VIEW_FASTSWITCH             ENABLE//DISABLE // display single sensor method (ENABLE: always display by Pipview, DISABLE: display by direct path)
...
//   USBCAM FUNCTIONS
//==============================================================================
#define UVAC_MODE_2_PATH                ENABLE//DISABLE
